...
class _LdvHttpClient implements LdvHttpClient {
  _LdvHttpClient(this._dio, {this.baseUrl, this.errorLogger}) {
    baseUrl ??= 'https://backend.larrelter-dorfverein.de/api/';
  }
  ...
  @override
  Future<List<TaskDto>> getTasksByBranch({required Branch branch}) async {
